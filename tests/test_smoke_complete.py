...
from backend.db.models import User, APIKey, CompanyTenant, Ticket, Deployment
...
class TestCompleteSmokeTests:
    ...
    def test_smoke_all_models_create(self, db_session):
        ...
        from backend.db.models import (
            User, CompanyTenant, Ticket, Project, Lead,
            UsageEvent, ProcessedEvent, Deployment, APIKey
        )
