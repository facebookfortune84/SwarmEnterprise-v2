...
class CodeReviewer:
    ...
    async def review(
        ...
        logger.info(f"Code review complete: {len(self.issues)} issues found, score: {score:.1f}/100")
        return result
    ...
    async def _generate_recommendations(self) -> List[str]:
        ...
        response = await self.ollama.generate(
            prompt,
            system="You are a senior software engineer providing code review feedback."
        )
